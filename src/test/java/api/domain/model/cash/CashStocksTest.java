...
public class CashStocksTest {

  @DisplayName("Nullで初期化")
  @Test
  void testInitializeNull() {
    Assertions.assertThrows( IllegalArgumentException.class, () -> new CashStocks( null ) );
  }

  @DisplayName("空リストで初期化")
  @Test
  void testInitializeEmptyList() {
    var cashStock = new CashStocks( new ArrayList<>() );
  ...
  void testInitializeCashInoutList() {
    var cashStock = new CashStocks( testCashInoutList );
